...
class MyLstmModel(tf.keras.Model):
    def __init__(self):
        ...
        self.forward_layer_one = layers.LSTM(64, kernel_regularizer=tf.keras.regularizers.l1_l2(l1=1e-08,l2=1e-10), bias_regularizer=tf.keras.regularizers.l1_l2(l1=1e-06,l2=1e-08), activity_regularizer=tf.keras.regularizers.l1_l2(l1=1e-06,l2=1e-08), recurrent_regularizer=tf.keras.regularizers.l1_l2(l1=1e-08,l2=1e-10), dropout=0.3, return_sequences=True)
        self.backward_layer_one = layers.LSTM(64, kernel_regularizer=tf.keras.regularizers.l1_l2(l1=1e-08,l2=1e-10), bias_regularizer=tf.keras.regularizers.l1_l2(l1=1e-06,l2=1e-08), activity_regularizer=tf.keras.regularizers.l1_l2(l1=1e-06,l2=1e-08), recurrent_regularizer=tf.keras.regularizers.l1_l2(l1=1e-08,l2=1e-10) , dropout=0.3, return_sequences=True , go_backwards=True)
        self.bi_one = layers.Bidirectional(self.forward_layer_one, backward_layer=self.backward_layer_one, name='bi_one')

        self.forward_layer_two = layers.LSTM(32, kernel_regularizer=tf.keras.regularizers.l1_l2(l1=1e-08,l2=1e-10), bias_regularizer=tf.keras.regularizers.l1_l2(l1=1e-06,l2=1e-08), activity_regularizer=tf.keras.regularizers.l1_l2(l1=1e-06,l2=1e-08), recurrent_regularizer=tf.keras.regularizers.l1_l2(l1=1e-08,l2=1e-10), dropout=0.3, return_sequences=True)
        self.backward_layer_two = layers.LSTM(32, kernel_regularizer=tf.keras.regularizers.l1_l2(l1=1e-08,l2=1e-10), bias_regularizer=tf.keras.regularizers.l1_l2(l1=1e-06,l2=1e-08), activity_regularizer=tf.keras.regularizers.l1_l2(l1=1e-06,l2=1e-08), recurrent_regularizer=tf.keras.regularizers.l1_l2(l1=1e-08,l2=1e-10) , dropout=0.3, return_sequences=True, go_backwards=True)
