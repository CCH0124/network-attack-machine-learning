...
class MyLstmModel(tf.keras.Model):
    def __init__(self):
        ...
        self.forward_layer_one = layers.LSTM(32, dropout=0.3, return_sequences=True) # bias_regularizer=tf.keras.regularizers.l1_l2(l1=1e-08,l2=1e-10),activity_regularizer=tf.keras.regularizers.l1_l2(l1=1e-08,l2=1e-08)
