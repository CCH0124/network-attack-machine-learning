...
##### 20200916-114347-network5-RMSprop
- optimizer
    - learning_rate=0.001
    - momentum=0.89
- train
...
- predict
```
TrueNegatives result:  130440.0
TruePositives result:  66807.0
FalseNegatives result:  8974.0
FalsePositives result:  1201.0
Recall result:  0.8815798
Precision result:  0.98234034
```
- fig
...
##### 20200916-125544-network5-RMSprop
- optimizer
    - learning_rate=0.001
    - momentum=0.89
- train
...
- predict
```
TrueNegatives result:  128341.0
TruePositives result:  72542.0
FalseNegatives result:  3239.0
FalsePositives result:  3300.0
Recall result:  0.9572584
Precision result:  0.9564885
```
- fig
    - figure\20200916-125544-network5-RMSprop
